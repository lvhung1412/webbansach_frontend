                ...
                <div className="col-8">
                    <div className="row">
                        <div className="col-8">
                            ...
                            <h4>
                                {dinhDangSo(sach.giaBan)}
                            </h4>
                            <hr/>
                                <div dangerouslySetInnerHTML={{__html: (sach.moTa+'')}} className="text-start"/>
                            <hr/>
                        </div>
                        <div className="col-4">
                            <div>
                                ...
                                <div className="d-grid">
                                    <button type="button" className="btn btn-danger" onClick={handleMuaNgay}>Mua ngay</button>
                                    <button type="button" className="btn btn-btn-outline-secondary mt-2" onClick={handleThemVaoGioHang}>Thêm vào giỏ hàng</button>
                                </div>
                            </div>
                        </div>
                    </div>
