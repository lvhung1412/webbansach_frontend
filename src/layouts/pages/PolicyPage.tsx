	...
	return (
		<div className='container my-5 bg-super-light p-4 rounded'>
			...
			<p>
				...
				khuyết, hư hỏng hoặc không như mô tả, HungBook cam kết bảo vệ khách
			...
			<p>
				...
				<a href='#!chinh-sach-doi-tra-hang'>
					<strong>hungBook.com/chinh-sach-doi-tra-hang</strong>
				</a>{" "}
			...
			<ul>
				<li>
					<p>Quý khách vui lòng thông báo về cho HungBook ngay khi:</p>
					<p>
						{" "}
				...
				<li>
					<p>
						Sau khi HungBook xác nhận mail tiếp nhận yêu cầu kiểm tra xử
						lý, HungBook sẽ liên hệ đến quý khách để xác nhận thông tin
						hoặc nhờ bổ sung thông tin (nếu có). Trường hợp không liên hệ
						được HungBook rất tiếc xin được phép từ chối xử lý yêu cầu.
						Thời gian HungBook liên hệ trong giờ hành chính tối đa 3 lần
			...
			<p>
				...
				<strong>HungBook</strong> trong vòng 30 ngày kể từ khi nhận hàng với
			...
			<br />
			<p>
				<strong>HungBook</strong> hỗ trợ đổi/ trả sản phẩm cho quý khách nếu:
			</p>
			<ul>
				<li>
			...
			<ul>
				<li>
					<p>
						...
						<strong>cskh@hungBook.com.vn</strong> với tiêu đề{" "}
			...
			<ul>
				<li>
					Để đảm bảo quyền lợi khách hàng và để <strong>HungBook</strong> có
					...
					clip từ quý khách, <strong>HungBook</strong> xin phép từ chối hỗ
					trợ.
				</li>
			</ul>
			<table
			...
			>
				<tbody>
					...
					<tr>
						...
						<td>
							<p>HungBook có sản phẩm→ đổi mới cùng sản phẩm</p>
							<p>
								HungBook hết hàng→ Hoàn tiền hoặc quý khách có thể chọn
								mặt hàng khác tại website{" "}
								<span style={{ textDecoration: "underline" }}>
									<a href='#!'>www.HungBook</a>
								</span>
								.
							</p>
					...
					<tr>
						...
						<td>
							...
							<p>
								**Lưu ý: HungBook rất tiếc sẽ không hỗ trợ hoàn lại chi
